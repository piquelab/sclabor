...
cd \${TMPDIR}/${sample};
time kb count --h5ad -i ${kref}/index.idx -o ${sample} -g ${kref}/t2g.txt -x 10xv2 -c1 ${kref}/spliced_t2c.txt -c2 ${kref}/unspliced_t2c.txt --nucleus --filter bustools --verbose -t 6 ${fastqlist};
